...
$args = [
	...
	'comment_field'      => sprintf(
		...
		sprintf(
			'outlined' === $style ? $outlined_label : $filled_label,
			'comment-label',
			esc_html__( 'Comeza a escribir aquí', 'material-design-google' )
		)
	),
	'submit_button'      => '<button id="%2$s" class="mdc-button mdc-button--raised mdc-ripple-upgraded %3$s" type="submit"><span class="mdc-button__ripple"></span><span class="mdc-button__label">Compartir experiencia</span></button>',
];

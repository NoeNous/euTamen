...
(function ($) {
  ...
  Object.keys(materialDesignThemeColorControls).forEach(function (control) {
    api(control, function (value) {
      return value.bind(function () {
        return generatePreviewStyles(materialDesignThemeColorControls);
      });
    });
  });

  if (materialDesignThemeColorControlsDark) {
    Object.keys(materialDesignThemeColorControlsDark).forEach(function (control) {
      api(control, function (value) {
        return value.bind(function () {
          return generatePreviewStyles(materialDesignThemeColorControlsDark);
        });
      });
    });
  }
  ...
  $(function () {
    api.preview.bind('active', function () {
      api.preview.bind('materialDesignThemePaletteUpdate', function (message) {
  ...
  var generatePreviewStyles = function generatePreviewStyles(selectedControls) {
    ...
    Object.keys(selectedControls).forEach(function (control) {
      var cssVar = selectedControls[control];
    ...
    Object.keys(materialDesignThemeColorControlsDark).forEach(function (control) {
      var cssVar = materialDesignThemeColorControlsDark[control];
      var color = parentApi(control).get();
      ...
      darkStyles += "".concat(cssVar, ": ").concat(color, ";");
      darkStyles += "".concat(cssVar, "-rgb: ").concat(hexToRgb(color).join(','), ";");
    ...
    Object.keys(materialDesignThemeColorControls).forEach(function (control) {
      ...
      lightStyles += "".concat(cssVar, ": ").concat(color, ";");
      lightStyles += "".concat(cssVar, "-rgb: ").concat(hexToRgb(color).join(','), ";");
  ...
  var updateColorMode = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["debounce"])(function (mode) {
    var colorControls;
    ...
    var switcherIcon = document.querySelector('.dark-mode__button');
  ...
  api.selectiveRefresh.bind('partial-content-rendered', function (placement) {
    ...
    Object(_front_end_components_masonry__WEBPACK_IMPORTED_MODULE_1__["masonryInit"])();
  });
})(jQuery);

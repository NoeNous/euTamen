...
class Ch_Th_Gen_Functions {
	...
	* @since  1.0.0
	*/
	public static function child_themes_setup() {
		$parent_themes = (array) self::get_parent_themes();
		...
		public static function remove_child_theme() {
	 ...
	 * @since  1.0.0
	 */
	public static function delete_theme_folder( $folder_to_remove, $parent_to_restore ) {
		$response = array();
	 ...
	 * @return null
	 */
	public static function get_child_themes() {
	 ...
	 * @return null
	 */
	public static function get_parent_themes() {
		// getting all installed themes
		$all_themes = wp_get_themes();
		$parent_themes = array();
		// building and return only parent-themes array
	 ...
	 * @since  1.0.0
	 */
	public static function files_generation($new_child_theme) {
	 ...
	 */	
	public static function create_style_css( $new_child_theme, $results ) {
	 ...
	 * @return 		mixed 			The settings field
	 */
	public static function create_functions_php( $new_child_theme, $results ) {
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	 ...
	 * @return 		mixed 			The settings field
	 */
	public static function create_screenshot_png( $new_child_theme, $results ) {
